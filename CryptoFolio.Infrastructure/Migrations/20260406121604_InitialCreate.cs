        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorites_CryptoCurrencies_CryptoID",
                        column: x => x.CryptoID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalFiatValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAssets_CryptoCurrencies_CryptoID",
                        column: x => x.CryptoID,
                        principalTable: "CryptoCurrencies",
                        principalColumn: "CryptoID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WalletTransactions", x => x.LogId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_CryptoID",
                table: "Favorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_UserId_CryptoID",
                table: "Transactions",
                columns: new[] { "UserId", "CryptoID" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAssets_CryptoID",
                table: "UserAssets",
                column: "CryptoID");

            migrationBuilder.CreateIndex(
                name: "IX_UserAssets_UserId_CryptoID",
                table: "UserAssets",
                columns: new[] { "UserId", "CryptoID" });
